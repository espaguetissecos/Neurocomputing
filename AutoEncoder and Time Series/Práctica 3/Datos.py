...
class Datos(object):
    ...
    def dataparser(self, nombreFichero):
        with open(nombreFichero, "r") as f:
            ...
            for j in range(0, lineas):
                ...
                array_aux = np.append(array_aux, (linea_aux[int(num_atributos):(int(num_atributos)+int(self.num_clase))]))
                if (j == 0):
